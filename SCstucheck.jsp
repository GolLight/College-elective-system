...
<body>
     ...
     String query = "SELECT * FROM Student where s_id='"+sno+"';";
     ...
     <p style="text-align:center"> 
        <%
           if(result.next()){
        	   if(spass.equals(result.getString("s_password")))
        	   {
        		   statement.close();
        	   	   connection.close();
        	   		out.println("验证通过，请点击确定跳转!");%>
        	   <p style="text-align:center"><a href="SCstuop.jsp?sno=<%=sno%>">确定</a></p>
               <%   
        	   }
        	   else
        	   {
        	   		...
        	   		out.println("密码错误！！！！");
        	   	%>
        	   		<p style="text-align:center"><a href="SCstulogin.jsp">返回登录界面</a></p>
               <% 
        	   }
